# 1 "../drivers/microchip/PIC18F452/uart/src/uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../drivers/microchip/PIC18F452/uart/src/uart.c" 2
# 12 "../drivers/microchip/PIC18F452/uart/src/uart.c"
# 1 "../drivers/microchip/PIC18F452/uart/inc\\uart.h" 1
# 17 "../drivers/microchip/PIC18F452/uart/inc\\uart.h"
...
# 17 "../drivers/microchip/PIC18F452/uart/inc\\uart.h" 2

# 1 "../app/inc\\cpu_set.h" 1
# 15 "../app/inc\\cpu_set.h"
...
# 18 "../drivers/microchip/PIC18F452/uart/inc\\uart.h" 2
...
# 12 "../drivers/microchip/PIC18F452/uart/src/uart.c" 2
...
void set_baud(uint32_t baud_rate_u32)
{
    if(baud_rate_u32 < (9803UL) && baud_rate_u32 >= (2441UL))
    {
        TXSTAbits.BRGH = 0;
        SPBRG = (uint8_t)(((40000000ULL) / baud_rate_u32 / 64) - 1);
    }
    else if(baud_rate_u32 >= (9803UL) && baud_rate_u32 <= (2500000ULL))
    {
        TXSTAbits.BRGH = 1;
        SPBRG = (uint8_t)(((40000000ULL) / baud_rate_u32 / 16) - 1);
    }
    else
    {
        SPBRG = (uint8_t)(((40000000ULL) / (2441UL) / 64) - 1);
...
void uart_drv_init(uart_tst self)
{
    ...
    self->uart_conf_st.set_baud((125000ULL));
